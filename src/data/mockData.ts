export const categories = [
  { id: 1, name: "Pizza", icon: "🍕", image: "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=400" },
  { id: 2, name: "Indian", icon: "🍛", image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400" },
  { id: 3, name: "Chinese", icon: "🥡", image: "https://images.unsplash.com/photo-1526318896980-cf78c088247c?w=400" },
  { id: 4, name: "Burgers", icon: "🍔", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400" },
  { id: 5, name: "Sushi", icon: "🍱", image: "https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=400" },
  { id: 6, name: "Desserts", icon: "🍰", image: "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400" },
  { id: 7, name: "Italian", icon: "🍝", image: "https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=400" },
  { id: 8, name: "Mexican", icon: "🌮", image: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400" },
];
...
export const vendorDetails = {
  ...
  description: "Experience authentic Indian cuisine with a modern twist. Our chef brings 25 years of culinary expertise.",
  ...
  reviews: [
    {
      ...
      rating: 5,
      date: "Mar 15, 2026",
      comment: "Absolutely incredible! The butter chicken was divine and the naan was perfectly crispy.",
    ...
    },
    {
      ...
      rating: 4,
      date: "Mar 12, 2026",
      comment: "Great food and fast delivery. The biryani was aromatic and flavorful.",
    ...
    },
    {
      ...
      rating: 5,
      date: "Mar 10, 2026",
      comment: "Best Indian food in town! Chef's recommendations are always on point.",
...
export const recentOrders = [
  { id: "#2456", customer: "John Doe", restaurant: "Golden Palace", amount: "$45.99", status: "Preparing", time: "5 min ago" },
  { id: "#2455", customer: "Jane Smith", restaurant: "Bella Italia", amount: "$38.50", status: "Delivered", time: "12 min ago" },
  { id: "#2454", customer: "Mike Johnson", restaurant: "Dragon Wok", amount: "$52.30", status: "On the way", time: "18 min ago" },
  { id: "#2453", customer: "Sarah Wilson", restaurant: "Sushi Master", amount: "$67.80", status: "Preparing", time: "25 min ago" },
  { id: "#2452", customer: "Tom Brown", restaurant: "The Burger House", amount: "$28.90", status: "Delivered", time: "32 min ago" },
];
